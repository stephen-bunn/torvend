...
latex_documents = [
    (master_doc, 'torvend.tex', 'torvend Documentation',
     'Stephen Bunn', 'manual'),
]
...
man_pages = [
    (master_doc, 'torvend', 'torvend Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'torvend', 'torvend Documentation',
     author, 'torvend', 'One line description of project.',
     'Miscellaneous'),
]
